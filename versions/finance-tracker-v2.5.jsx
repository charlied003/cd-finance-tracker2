...
function detectSubscriptions(allTxns) {
  ...
  Object.entries(byKey).forEach(([, { txns, nameCounts }]) => {
    ...
    subs.push({ name: displayName, amount: avgAmount, frequency, lastPaid: last.date, daysSince, nextDue: nextDate.toISOString().slice(0, 10), daysUntil, category: last.category || "Other", count: sorted.length });
  });
